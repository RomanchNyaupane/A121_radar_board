...
#define A121_ENABLE_GPIO_Port    GPIOA
#define A121_ENABLE_Pin          GPIO_PIN_2
...
static void acc_hal_integration_sensor_transfer(acc_sensor_id_t sensor_id, uint8_t *buffer, size_t buffer_size)
{
	...
	HAL_GPIO_WritePin(A121_ENABLE_GPIO_Port, A121_ENABLE_Pin, GPIO_PIN_SET);
...
HAL_GPIO_WritePin(A121_ENABLE_GPIO_Port, A121_ENABLE_Pin, GPIO_PIN_RESET);
...
bool acc_hal_integration_wait_for_sensor_interrupt(acc_sensor_id_t sensor_id, uint32_t timeout_ms)
{
	...
	GPIO_TypeDef  *int_port      = A121_INT_GPIO_Port;
	uint32_t       int_pin_mask  = A121_INT_Pin;
